...
class StepBoundaryArtifactButIT {

	@Test
	void samples_atStepBoundary_arentEqual() {
		...
		System.out.println(audioConsumerSpy.getSample(733));
		System.out.println(firstStepLastSample);
		System.out.println(secondStepFirstSample);
		System.out.println(audioConsumerSpy.getSample(736));
