...
class AsrEnvelopeTest {
	...
	void getEnvelope_outsideDuration_returns0() {
		Envelope asrEnvelope = AsrEnvelope.linear(0.1f, 0.1f);
		float duration = 1f;
	...
	@Test
	void getEnvelope_duringSustain_returns1() {
		Envelope asrEnvelope = AsrEnvelope.linear(0.1f, 0.1f);
		float duration = 1f;

		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.1f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.2f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.3f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.4f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.5f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.6f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.7f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.8f));
		assertEquals(1f, asrEnvelope.getEnvelope(duration, 0.9f), ALLOWED_ERROR);
	}
